...
if (!/versionCode\s+10/.test(appBuildGradle) || !/versionName\s+"1\.0\.9"/.test(appBuildGradle)) {
  console.error("Android Gradle config must keep the approved 1.0.9 / code 10 identity.");
  process.exit(1);
}
