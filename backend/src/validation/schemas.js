...
export const schemas = {
  ...
  standUpsert: {
    body: Joi.object({
      ...
      stand_type: Joi.string().valid("individual", "service", "").optional(),
      standType: Joi.string().valid("individual", "service", "").optional(),
      marketplace_mode: Joi.forbidden(),
      marketplaceMode: Joi.forbidden(),
      ...
      pickup_available: Joi.forbidden(),
      pickupAvailable: Joi.forbidden(),
