...
async function main() {
  ...
  try {
    ...
    await importTable(pgClient, sqlite, "barbers", [
      ...
      { name: "marketplace_mode", defaultValue: "service" },
      ...
      { name: "cover_image_url", defaultValue: "" },
      { name: "business_hours_json", defaultValue: "{}" },
      { name: "delivery_available", defaultValue: 0 },
      { name: "pickup_available", defaultValue: 1 },
      { name: "delivery_areas_json", defaultValue: "[]" },
      { name: "delivery_fee" },
      { name: "delivery_notes", defaultValue: "" },
    ...
    await importTable(pgClient, sqlite, "products", [
      { name: "id" },
      { name: "stand_id" },
      { name: "owner_user_id" },
      { name: "name" },
      { name: "slug", defaultValue: "" },
      { name: "description", defaultValue: "" },
      { name: "category", defaultValue: "" },
      ...
      { name: "sale_price" },
      { name: "currency", defaultValue: "UGX" },
      { name: "stock_status", defaultValue: "in_stock" },
      { name: "quantity_available" },
      { name: "options_json", defaultValue: "[]" },
      { name: "is_active", defaultValue: 1 },
      { name: "is_deleted", defaultValue: 0 },
      { name: "created_at" },
      { name: "updated_at" },
    ]);

    await importTable(pgClient, sqlite, "product_images", [
      { name: "id" },
      { name: "product_id" },
      { name: "image_url" },
    ...
    await importTable(pgClient, sqlite, "product_orders", [
      { name: "id" },
      { name: "customer_id" },
      { name: "stand_id" },
      { name: "seller_user_id" },
      ...
      { name: "customer_name", defaultValue: "" },
      { name: "customer_phone" },
      { name: "delivery_area", defaultValue: "" },
      { name: "delivery_address", defaultValue: "" },
      { name: "customer_note", defaultValue: "" },
      { name: "seller_note", defaultValue: "" },
      { name: "subtotal", defaultValue: 0 },
      { name: "delivery_fee", defaultValue: 0 },
    ...
    await importTable(pgClient, sqlite, "product_order_items", [
      { name: "id" },
      { name: "order_id" },
      { name: "product_id" },
      { name: "product_name_snapshot" },
      { name: "product_price_snapshot", defaultValue: 0 },
      { name: "product_image_snapshot", defaultValue: "" },
      { name: "selected_options_json", defaultValue: "{}" },
      { name: "quantity", defaultValue: 1 },
      { name: "line_total", defaultValue: 0 },
    ]);

    await importTable(pgClient, sqlite, "product_order_events", [
      { name: "id" },
      { name: "order_id" },
      { name: "actor_id" },
      { name: "old_status", defaultValue: "" },
      { name: "new_status" },
      { name: "note", defaultValue: "" },
      { name: "created_at" },
    ]);

    await importTable(pgClient, sqlite, "product_inquiries", [
      { name: "id" },
      { name: "product_id" },
      { name: "stand_id" },
      { name: "customer_id" },
