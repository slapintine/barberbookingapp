...
import customerPremiumFeatureRoutes from "./routes/customerPremiumFeatureRoutes.js";
import providerPremiumFeatureRoutes from "./routes/providerPremiumFeatureRoutes.js";
import providerPlatinumOperationsRoutes from "./routes/providerPlatinumOperationsRoutes.js";
...
app.use("/api/customer-premium", customerPremiumFeatureRoutes);
app.use("/api/provider-premium", providerPremiumFeatureRoutes);
app.use("/api/provider-platinum", providerPlatinumOperationsRoutes);
app.use("/api/ai-coach", aiCoachRoutes);
app.use("/api/provider/coach", aiCoachRoutes);
app.use("/api/provider-coach", providerCoachChatRoutes);
