...
import { SERVICE_DISCOVERY_CATEGORIES } from "../../utils/serviceCatalog.js";
...
// Built from the same SERVICE_DISCOVERY_CATEGORIES used on the Categories page and throughout the app.
    ...
    <div className="qmm-sheet-inner" data-testid="map-provider-preview">
      ...
      <div className="qmm-sheet-body">
        ...
        <div className="qmm-sheet-stats">
          {ratingLabel === "New" ? <span className="qmm-new-badge">New</span> : <><FiStar className="qmm-star-icon" /><b>{ratingLabel}</b></>}
          {reviewCount > 0 && (
        ...
        {isOwner ? (
          ...
          <>
            <button type="button" className="qmm-btn-primary" onClick={() => onOpenProvider?.(provider)}>
              <FiCalendar /> <span>Book now</span> <FiArrowRight className="qmm-btn-primary-arrow" />
            </button>
