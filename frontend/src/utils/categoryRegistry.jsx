...
// Ordered category set used by the Home "Browse by Category" rail. Exported so
// the public website can show the same names/order without maintaining a second
// homepage-only list. Map markers continue to use mapIconCategories.js.
...
const LEGACY_ICON_KEY_MAP = {
  ...
  auto: "auto-services",
  "auto-and-mechanic": "auto-services",
  ...
  errands: "errands-local-help",
  "local-help": "errands-local-help",
  repairs: "repairs-maintenance",
  "home-repair": "repairs-maintenance",
  ...
  "moving-services": "moving-transport",
