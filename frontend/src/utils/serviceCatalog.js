export const SERVICE_CATEGORY_DEFINITIONS = [
  ...
  },
  {
    ...
    description: "Courier runs, errands, pickup, delivery, document drops, and personal tasks.",
    image: "https://images.unsplash.com/photo-1617347454431-f49d7ff5c3b1?auto=format&fit=crop&w=900&q=80",
    active: true,
  },
  { id: "website-app-development", icon: "briefcase", name: "Website & App Development", description: "Websites, mobile apps, booking tools, automation, and technical builds.", image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900&q=80", active: true },
...
export const CATEGORY_ALIASES = {
  ...
  spa: ["spa", "massage", "wellness", "facial", "relaxation"],
