    ...
    <div className="admin-view-v17">
      ...
      <section className="admin-card-v17">
        ...
        <form className="admin-form-grid-v17" onSubmit={submitAnnouncement}>
          ...
          <label>
            <span>Message</span>
            <textarea value={announcementDraft.body} onChange={(event) => setAnnouncementDraft((prev) => ({ ...prev, body: event.target.value }))} maxLength={1000} rows={4} placeholder="Share an operational update, policy change, or service-booking announcement." />
          </label>
